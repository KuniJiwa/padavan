...
<div class="wrapper">
    <div class="container-fluid" style="padding-right: 0px">
        <div class="row-fluid">
			<div class="span3" style="text-align:center;"><div id="logo"></div></div>
            <div class="span9" >
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div id="wnd_sm_cfg">
                                        ...
                                        <tr> <th width="50%"><#SmartDNS1#></th>
                                            <td>
												...
												<div><span style="color:#888;">留空用系统主机名</span></div>
                                            </td>
                                        </tr>
                                        <tr> <th width="50%"><#SmartDNS2#></th>
                                            <td>
												...
												<div><span style="color:#888;">默认 53</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS3#></th>
                                            <td>
												...
												</div><span style="color:#888;"><#SmartDNS3_1#></span>
                                                <div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%"><#SmartDNS4#></th>
                                            <td>
												...
												</div><span style="color:#888;"><#SmartDNS4_1#></span>
                                                <div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%"><#SmartDNS5#></th>
											<td>
												...
												<div><span style="color:#888;">无：不接管；dnsmasq 上游：由 dnsmasq 转发；重定向 53：劫持 53 端口到 SmartDNS</span></div>
											</td>
										</tr>
                                        ...
                                        <tr> <th width="50%"><#SmartDNS7#></th>
											<td>
												...
												<div><span style="color:#888;">缓存文件保存到 /tmp/smartdns.cache</span></div>
                                                <div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%"><#SmartDNS10#></th>
                                            <td>
												...
												<div><span style="color:#888;"><#SmartDNS10_1#></span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS11#></th>
                                            <td>
												...
												<div><span style="color:#888;"><#SmartDNS11_1#></span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS12#></th>
                                            <td>
												...
												<div><span style="color:#888;">留空用上游结果</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS13#></th>
                                            <td>
												...
												<div><span style="color:#888;">默认 3</span></div>
											</td>
										</tr>
										<tr> <th width="50%"><#SmartDNS8#></th>
											<td>
												...
												<div><span style="color:#888;">单位：秒，默认 120</span></div>
                                            </td>
                                        </tr>
										</table>
										</div>
                                        ...
                                        <tr> <th width="50%"><#SmartDNS19#></th>
                                            <td>
												...
												<div><span style="color:#888;"><#SmartDNS19_1#></span></div>
											</td>
										</tr>
										...
										<tr> <th width="50%"><#SmartDNS20#></th>
											...
											<td>
												<select name="sdns_response_mode" class="input" style="width: 200px">
													<option value="first-ping" <% nvram_match_x("","sdns_response_mode", "first-ping","selected"); %>>first-ping</option>
													<option value="fastest-ip" <% nvram_match_x("","sdns_response_mode", "fastest-ip","selected"); %>>fastest-ip</option>
													<option value="fastest-response" <% nvram_match_x("","sdns_response_mode", "fastest-response","selected"); %>>fastest-response</option>
												</select>
												<div><span style="color:#888;"><#SmartDNS35_1#></span></div>
                                            </td>
                                        </tr>
										...
										<tr> <th width="50%"><#SmartDNS22#></th>
                                            <td>
												<input type="text" maxlength="64" class="input" size="64" name="sdns_ip_change_time" style="width: 120px" value="<% nvram_get_x("", "sdns_ip_change_time"); %>"> 毫秒（0-1000）
												<div><span style="color:#888;">单位：毫秒，范围 0-1000，默认 10</span></div>
                                            </td>
                                        </tr>
										...
										<tr> <th width="50%"><#SmartDNS27#></th>
                                            <td>
												...
												</div><span style="color:#888;"><#SmartDNS27_1#></span>
                                                <div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%"><#SmartDNS26#></th>
											<td>
												...
												<div><span style="color:#888;">缓存到期前主动重新查询，避免用户请求时等待</span></div>
												<div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%"><#SmartDNS34#></th>
                                            <td>
												...
												<div><span style="color:#888;">上游需填写相同组名，此端口才走该组 例如: oversea, office, home</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS2#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="sdnse_port" style="width: 200px" value="<% nvram_get_x("", "sdnse_port"); %>">
												<div><span style="color:#888;">默认 7053</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS3#></th>
                                            <td>
                                        ...
                                        <tr> <th width="50%">上游名称:</th>
										    <td>
												...
												<div><span style="color:#888;">仅用于列表显示，不写入配置</span></div>
                                            </td>
										</tr>
                                        <tr> <th width="50%">上游地址:</th>
										    <td>
												...
												<div><span style="color:#888;">IP 或域名；https 类型填 URL，例如: https://dns.google/dns-query</span></div>
                                            </td>
										</tr>
                                        <tr> <th width="50%">上游端口:</th>
										    <td>
												<input type="text" maxlength="255" class="span12" style="width: 200px" size="200" name="sdnss_port_x_0" placeholder="default" value="<% nvram_get_x("", "sdnss_port_x_0"); %>" onKeyPress="return is_string(this,event);"/>
												<div><span style="color:#888;">留空用协议默认端口（udp/tcp 53、tls 853、https 443）</span></div>
											</td>
										</tr>
										...
										<tr> <th colspan="2" style="background-color: #E3E3E3;">给上游分组命名，配合 nameserver 规则使用；不需要分组可留空</th></tr>
										...
										<tr> <th width="50%">加入ipset(解析gfwlist要用):</th>
										    <td>
												...
												<div><span style="color:#888;">填 IP：直接加入 ipset「smartdns」</span></div>
												<div><span style="color:#888;">填域名：生成 ipset /域名/smartdns 规则；例如: 8.8.8.8 或 google.com</span></div>
											</td>
										</tr>
                                        ...
                                        <tr>
											<td style="text-align:center;"><input name="ManualRULESList2" type="submit" class="btn btn-primary" style="width: 100px" onclick="return markGroupRULES(this, 64, ' Add ');" value="保存上游"/></td>
                                        </tr>
										</table>
                                        ...
                                        <tr id="row_rules_caption">
											...
											<th width="5%" style="text-align:center;"><i class="icon-th-list"></i></th>
                                        </tr>
										...
										<tr>
											...
											<td>
												...
												<div><span style="color:#888;">需缓存 > 0 才生效</span></div>
											</td>
										</tr>
										<tr>
											...
											<td>
												...
												<div><span style="color:#888;">广告规则文件 URL，默认: https://anti-ad.net/anti-ad-for-smartdns.conf</span></div>
											</td>
										</tr>
										<tr> <th width="50%">加载ChnrouteIP为白名单</th>
                                            <td>
												...
												<div><span style="color:#888;">仅接受白名单内的 IP 结果</span></div>
												<div><span style="color:#888;">需在上游服务器中开启 -whitelist-ip 过滤</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%">加载ChnrouteIP为黑名单</th>
                                            <td>
												...
												<div><span style="color:#888;">过滤黑名单内的 IP 结果</span></div>
												<div><span style="color:#888;">需在上游服务器中开启 -blacklist-ip 过滤</span></div>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="table">									
                                        <tr>
                                            <td colspan="6">
												<div style="text-align:center;"><input class="btn btn-primary" style="width: 219px" type="button" value="<#CTL_apply#>" onclick="applyRule()" /></div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
